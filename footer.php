					<footer id="footer" class="site-footer card shadow-sm border-0">
						...
						<!--计时-->
						<?php require('~/docker/wordpress/app/wp-content/themes/argon-theme/specialEffects/timeRAM.php');?>
					</footer>
				</main>
			</div>
		</div>
...
<?php wp_footer(); ?>
<!--个人特效-->
<?php require('~/docker/wordpress/app/wp-content/themes/argon-theme/specialEffects/common.php');?>
</body>
